                            ...
                            <form class="" method="post">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12 col-12 input-fields mb-4 mb-sm-0">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Name" required="required" oninvalid="setCustomValidity('Isi Dulu Bos!')" onkeyup="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-sm-12 col-12 input-fields">
                                        ...
                                        <input type="email" name="email" class="form-control" placeholder="Email" required="required" oninvalid="setCustomValidity('Isi Dulu Bos!')" onkeyup="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-sm-12 col-12 input-fields">
                                        ...
                                        <input type="text" name="subject" class="form-control" placeholder="Subject" required="required" oninvalid="setCustomValidity('Isi Dulu Bos!')" onkeyup="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12 col-12 input-fields">
                                        <textarea name="message" class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="Message" required="required" oninvalid="setCustomValidity('Isi Dulu Bos!')" onkeyup="setCustomValidity('')"></textarea>
                                    </div>
                                </div>
                                <div class="row">
