...
?>
    ...
    $query="SELECT * FROM contact ORDER BY id DESC LIMIT 999999"; 
      ...
      while($data=mysqli_fetch_array($queryrun)){
        // message
        $cipher_message = $data['cmessage'];
        $decrypted_message = decrypt($keyMatrixArray,$cipher_message);
        // email
        $cipher_email = $data['cemail'];
        $decrypted_email = decrypt($keyMatrixArray,$cipher_email);
        // name
        $cipher_name = $data['cname'];
        $decrypted_name = decrypt($keyMatrixArray,$cipher_name);
        // subject
        $cipher_subject = $data['csubject'];
        $decrypted_subject = decrypt($keyMatrixArray,$cipher_subject);
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="f-head">
                                                                    <div class="avatar avatar-sm">
                                                                        <h5 class="avatar-title rounded-circle"><?=@htmlentities(ucfirst($decrypted_name))[0]?></h5>
                                                                    </div>
                                                                </div>
                                                                <div class="f-body">
                                                                    <div class="meta-mail-time">
                                                                        <p class="user-email" data-mailto="<?=@htmlentities($decrypted_email)?>"><?=@htmlentities($decrypted_name)?></p>
                                                                    </div>
                                                                    <div class="meta-title-tag">
                                                                        <p
                                                                            class="mail-content-excerpt"
                                                                            data-maildescription='{"ops":[{"insert":"<?=@htmlentities($decrypted_message)?>\n"}]}'>
                                                                            <span class="mail-title" data-mailtitle="<?=@htmlentities($decrypted_subject)?>"><?=@htmlentities($decrypted_subject)?>
                                                                                -
                                                                            </span><?=@htmlentities($decrypted_message)?></p>
                                                                        <div class="tags">
          ...
          ?>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            data-mailto="<?=@htmlentities($decrypted_email)?>"
                                            data-mailcc="">
                                                ...
                                                <div class="d-flex user-info">
                                                    ...
                                                    <div class="f-body">
                                                        <div class="meta-title-tag">
                                                            <h4
                                                                class="mail-usr-name"
                                                                data-mailtitle="<?=@htmlentities($decrypted_subject)?>"><?=@htmlentities($decrypted_name)?></h4>
                                                        </div>
                                                        <div class="meta-mail-time">
                                                            <p class="user-email" data-mailto="<?=@htmlentities($decrypted_email)?>"><?=@htmlentities($decrypted_email)?></p>
                                            ...
                                            <p
                                                class="mail-content"
                                                data-mailtitle="<?=@htmlentities($decrypted_subject)?>"
                                                data-maildescription='{"ops":[{"insert":"<?=@htmlentities($decrypted_message)?>\n"}]}'>
                                                <?=@htmlentities($decrypted_message )?>
                                            </p>
